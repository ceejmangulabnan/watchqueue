...
const UserNav = ({ loading, isAuthed, handleLogout, auth }: UserNavProps) => {
    ...
    return (
        <div className="text-sm md:text-base hidden md:flex ml-4 items-center">
            <Avatar
            ...
            <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
                <DropdownMenuTrigger
                    className={
                        (isAuthed ? 'flex ' : 'hidden ') +
                        'ml-2 items-center justify-center hover:bg-gray-100 rounded-full w-6 h-6'
                    }
                >
                    <ChevronDown />
                </DropdownMenuTrigger>
