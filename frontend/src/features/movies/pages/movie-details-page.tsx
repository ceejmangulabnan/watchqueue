...
import RecommendedMovies from '@/features/movies/components/recommended-movies'
import { useUserWatchlists } from '@/features/watchlist/hooks/use-user-watchlists'
import useMediaDetails from '@/hooks/useMediaDetails'
import { Genre } from '@/features/tv/types/tv-types'
                ...
                <div className="flex flex-col items-center sm:flex-row pb-8 sm:py-8">
                    ...
                    <div className="flex flex-col p-4 flex-1">
                        ...
                        <div className="flex flex-col mt-4 gap-4">
                            <div>
                                <p
                                    className={`mt-2 md:mt-4 tracking-wider  text-sm md:text-lg italic font-medium ${movieDetails.tagline ? '' : 'hidden'}`}
                                >
                                ...
                                <DropdownMenuContent side={'right'}>
                                    {isAuthed ? (
                                        ...
                                        <div className="p-4">
                                            ...
                                            <p className="py-2">
                                                Please log in to create and add
                                                movies to watchlists.
                                            </p>
